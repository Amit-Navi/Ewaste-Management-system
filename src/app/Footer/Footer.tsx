...
import logo from "../../assets/GreenCircuit-s.png";
    ...
    <footer className="footer projects shadow-2xl">
      ...
      />
        <div className="container">
          <div className="footer-brand">
            ...
            GreenCircuit: Transforming E-Waste Management. Find E-waste facilities effortlessly with our platform. Your key to responsible recycling and sustainability.
            </p>
          ...
          <ul className="footer-list">
            ...
            <li className="footer-item">
              ...
              <Link
                target="_blank"
                rel="noopener noreferrer"
                href="mailto:contact@GreenCircuit.com"
                className="contact-link"
              >
                contact@GreenCircuit.com{" "}
              </Link>
            </li>
            <li className="footer-item">
      ...
      <div className="footer-bottom">
        ...
        <p className="copyright">
            &copy; 2023 GreenCircuit | All Rights Reserved by{" "}
